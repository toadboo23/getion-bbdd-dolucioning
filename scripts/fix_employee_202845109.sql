-- CORREGIR ESTADO DE BAJA DEL EMPLEADO 202845109

-- 1. Verificar estado actual del empleado 202845109
SELECT 
    cl.employee_id,
...
WHERE cl.employee_id = '202845109';
