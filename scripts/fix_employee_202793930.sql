-- CORREGIR ESTADO DE BAJA DEL EMPLEADO 202793930

-- 1. Verificar estado actual del empleado 202793930
SELECT 
    cl.employee_id,
...
WHERE cl.employee_id = '202793930';
