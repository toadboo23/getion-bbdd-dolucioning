...
Write-Host "   2. Ejecutar: git pull origin Production" -ForegroundColor White
Write-Host "   3. Ejecutar: docker-compose down && docker-compose up --build -d" -ForegroundColor White
Write-Host ""
